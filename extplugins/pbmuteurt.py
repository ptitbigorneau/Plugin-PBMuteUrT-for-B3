# PBMuteUrT Plugin for UrT
# Plugin for B3 (www.bigbrotherbot.com)
#
# V1.0.0 - 2012/03/24  - PtitBigorneau - www.ptitbigorneau.fr
#
# V1.1.0 - 2012/05/19  - PtitBigorneau - www.ptitbigorneau.fr
#
...
class PbmuteurtPlugin(b3.plugin.Plugin):
    ...
    def onStartup(self):
        ...
        self._adminPlugin.registerCommand(self, 'pbpermmute',self._adminlevelpermmute, self.cmd_pbpermmute, 'pmute')
        self._adminPlugin.registerCommand(self, 'pbtempmute',self._adminleveltempmute, self.cmd_pbtempmute, 'tmute')
        self._adminPlugin.registerCommand(self, 'pbunmute',self._adminlevelunmute, self.cmd_pbunmute, 'unmute')        
        self._adminPlugin.registerCommand(self, 'pbinfomute',self._adminlevelimute, self.cmd_pbinfomute, 'imute')
